...
class ProfileModelTest(TestCase):
    ...
    def test_profile_img_label(self):
        profile = Profile.objects.get(id=1)
        field_label = profile._meta.get_field("profile_img").verbose_name
    ...
    def test_get_absolute_url(self):
        ...
        self.assertEqual(profile.get_absolute_url(), "/profile/username/")
...
class PostModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        post_object = Post.objects.create(
            user=user, user_profile=user_profile, caption="caption"
        )
    ...
    def test_image_label(self):
        ...
        self.assertEqual(field_label, "Post image")
    ...
    def test_no_of_likes_label(self):
        ...
        self.assertEqual(field_label, "Number of likes")

    def test_comments_status_label(self):
        post = Post.objects.first()
        field_label = post._meta.get_field("comments_status").verbose_name
        self.assertEqual(
            field_label, "Comments(uncheck the box to turn off the comments)"
        )
    ...
    def test_get_author_photo(self):
        post = Post.objects.first()
        self.assertEqual(post.get_author_photo(), "/media/blank_profile.png")
...
class PostLikesModelTest(TestCase):
    ...
    def test_str(self):
        ...
        self.assertEqual(expected_object_name, str(post_like))
...
class PostCommentsModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        post_comment = PostComments.objects.create(
            user=user, user_profile=user_profile, text="text123", post=post
        )
    ...
    def test_created_at_label(self):
        ...
        self.assertEqual(field_label, "Comment likes")
    ...
    def test_str(self):
        ...
        expected_object_name = (
            f"Comment by {post_comment.user} - {post_comment.date}"
        )
        self.assertEqual(expected_object_name, str(post_comment))

    def test_user_photo(self):
        post_comment = PostComments.objects.first()
        self.assertEqual(post_comment.user_photo(), "/media/blank_profile.png")
...
class CommentLikesModelTest(TestCase):
    ...
    def test_str(self):
        ...
        self.assertEqual(expected_object_name, str(comment_like))
