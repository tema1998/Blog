...
urlpatterns = [
    ...
    path(
        ...
        views.ProfileFollowingCreateView.as_view(),
        name="follow",
    ),
    ...
    path(
        "add-remove-favorites/<str:post_id>/",
        views.AddRemoveFavoritePost.as_view(),
        name="add-remove-favorites",
    ),
    path(
        "favorites-posts",
        views.FavoritesPosts.as_view(),
    ...
    path(
        "edit-post/<str:post_id>/", views.EditPost.as_view(), name="edit-post"
    ),
    path(
        "like-post/<str:post_id>/", views.LikePost.as_view(), name="like-post"
    ),
    path("delete-post", views.DeletePost.as_view(), name="delete-post"),
    path(
        "disable-post-comments",
        views.DisablePostComments.as_view(),
        name="disable-post-comments",
    ),
    path(
        "enable-post-comments",
        views.EnablePostComments.as_view(),
