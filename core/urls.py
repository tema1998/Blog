...
urlpatterns = [
    ...
    path('followers/<int:user_id>/', views.FollowersList.as_view(), name='followers'),
    path('following/<int:user_id>/', views.FollowingList.as_view(), name='following'),
    ...
    path('like-post/<str:post_id>/', views.LikePost.as_view(), name='like-post'),
