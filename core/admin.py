...
class PostAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Post info", {"fields": ("no_of_likes", "created_at")}),
    )
    ...
    def get_html_image(self, object):
        if object.image:
            return mark_safe(
                f"<img src='{object.image.url}' width=50 height=50>"
            )
...
class ProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("User following settings", {"fields": ("following",)}),
    )
    readonly_fields = (
        "id",
        "user",
    ...
    def get_html_image(self, object):
        if object.profile_img:
            return mark_safe(
                f"<img src='{object.profile_img.url}' width=50 height=50>"
            )
